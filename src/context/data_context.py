...
class FuzzingContext:
    ...
    def prepare(cls,
        ...
        try:
            ...
            # buffers (declared ``const void*``) stay buffers. Always on (core
            # innovation ①; the LOGICFUZZ_DISABLE_TYPEDEF_RECOVERY gate was removed).
            try:
        ...
        if skeleton_drivers and api_semantic_model is not None:
            try:
                ...
                skeleton_drivers = subset_eliminate_skeletons(
                    skeleton_drivers, api_semantic_model, _valid_seqs)
